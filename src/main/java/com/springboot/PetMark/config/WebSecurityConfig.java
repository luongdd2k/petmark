...
=======
        http.authorizeRequests().antMatchers("/", "/CheckLogin", "/CheckLogout", "/css/**", "/Script/**","/Image/**","/font/**","/plugins/**","/dist/**","/admin/**","/shopper/**","/css/**","/fonts/**","/images/**","/js/**","/vendor/**","/resources/**").permitAll();
>>>>>>> 276a3265f64cf0b02c18cbd485061dec6003c44d
