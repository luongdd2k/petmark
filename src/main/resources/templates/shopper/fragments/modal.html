...
<div class="modal fade" th:fragment="addToCart" id="modalAddToCartProduct" tabindex="-1" role="dialog" aria-label="myModalLabel" aria-hidden="true">
...
<div class="modal fade" th:fragment="quickView" id="ModalquickView" tabindex="-1" role="dialog" aria-label="myModalLabel" aria-hidden="true">
...
<!-- modal (quickViewModal) -->
<div class="modal fade" th:fragment="quickViewAjax" id="ModalquickView" tabindex="-1" role="dialog" aria-label="myModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-lg">
		<div class="modal-content ">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true"><span class="icon icon-clear"></span></button>
...
<!-- 									</div> -->
						...
						<div class="col-12 col-md-7 col-lg-6">
							<div class="tt-product-single-info">
								<div class="tt-add-info">
									<ul>
										<li><span>ID:</span> <span th:text="${productView.id}"></span></li>
<!-- 										<li><span>Availability:</span> 40 in Stock</li> -->
									</ul>
								</div>
								<h2 class="tt-title" th:text="${productView.name2()}">Cotton Blend Fleece Hoodie</h2>
								<div class="tt-price">
									<span class="new-price" th:text="${productView.formatPrice()}">$29</span>
<!-- 									<span class="old-price"></span> -->
								</div>
								<div class="tt-review">
									<div class="tt-rating">
								...
								<div class="tt-swatches-container">
									<div class="tt-wrapper">
										...
										<form class="form-default">
											<div class="form-group">
												<select class="form-control">
													<option th:each="size : ${productView.sizes}" th:text="${size.size}">21</option>
												</select>
											</div>
										</form>
									</div>
...
<!-- Product Modal -->
<!-- modalVideoProduct -->
<div class="modal fade" th:fragment="videoProduct" id="modalVideoProduct" tabindex="-1" role="dialog" aria-label="myModalLabel" aria-hidden="true">
...
<div class="modal fade" th:fragment="subsribeGood"  id="ModalSubsribeGood" tabindex="-1" role="dialog" aria-label="myModalLabel" aria-hidden="true">
...
<!-- modal (shipping) -->
<div class="modal fade" th:fragment="shipping" id="modalProductInfo-02" tabindex="-1" role="dialog" aria-label="myModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-lg">
		<div class="modal-content ">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true"><span class="icon icon-clear"></span></button>
...
<!-- modal (size guide) -->
<div class="modal fade" th:fragment="size_guide"  id="modalProductInfo" tabindex="-1" role="dialog" aria-label="myModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-lg">
		<div class="modal-content ">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true"><span class="icon icon-clear"></span></button>
