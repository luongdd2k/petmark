...
(function (factory) {
    ...
    var Comments = {
        ...
        postComment: function(ev) {
            ...
            console.log('isAdmin: '+this.options.currentUserIsAdmin);
        ...
        createCommentWrapperElement: function(commentModel) {
            ...
            if(commentModel.isVip) {
                var newTag2 = $('<span/>', {
                    'class': 'new highlight-background',
                    text: this.options.textFormatter(this.options.newTextVip)
                });
                nameEl.append(newTag2);
            }
        ...
        createCommentJSON: function(textarea) {
            ...
            var commentJSON = {
                ...
                content: this.getTextareaContent(textarea),
                pings: this.getPings(textarea),
                fullname: this.options.textFormatter(this.options.currentFullname),
                profilePictureURL: this.options.profilePictureURL,
                createdByCurrentUser: true,
                createdByAdmin: this.options.currentUserIsAdmin, // checkpoint 1
                isNew: this.options.currentUserIsAdmin ? 'Quản trị viên' : '',
                upvoteCount: 0,
                userHasUpvoted: false
            };
            // console.log(this.options.currentUserIsAdmin);
            return commentJSON;
        },
