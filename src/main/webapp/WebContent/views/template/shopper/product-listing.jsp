...
<!-- 								<li class="active"><a href="#">a</a></li> -->
					...
					<div class="tt-collapse open">
						<h3 class="tt-collapse-title">MÀU</h3>
						<div class="tt-collapse-content">
							<ul class="tt-options-swatch options-middle" id="list-color">
								<li th:each="color : ${colors}"><a class="options-color" th:style="${'background: ' + color.code}" th:title="${color.name}" th:href="${color.id}"></a></li>
							</ul>
						</div>
					</div>

					<div class="tt-collapse open" th:if="${isSignedIn}">
						<h3 class="tt-collapse-title">SẢN PHẨM ĐÃ XEM</h3>
						<div class="tt-collapse-content">
							<div class="tt-aside">
								<a class="tt-item" href="product.html" th:each="product : ${productWatched}">
									...
									<div class="tt-content">
										<h6 class="tt-title" th:text="${product.name2()}">Flared Shift Dress</h6>
										<div class="tt-price">
...
<!-- 											<span class="old-price">$24</span> -->
					...
					<div class="tt-content-aside">
						<a href="javascript:;" class="tt-promo-03">
							<img src="images/banner/bnv.jpg" alt="">
						</a>
					</div>
				</div>
...
<!-- 								<span class="tt-title-total">(12)</span> -->
						...
						<div class="tt-product-listing row">
							<h5 th:if="${#lists.isEmpty(products)}">Hiện không có sản phẩm</h5>
								...
								<div class="tt-product thumbprod-center">
									...
									<div class="tt-description">
										...
										<h2 class="tt-title"><a th:href="@{/product/} + ${product.id}">
											<td th:text="${product.name + ' - ' + product.versionName}"></td></a></h2>
...
<script src="js/product-listing.js" type="text/javascript"></script>
</body>
</html>