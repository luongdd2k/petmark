				...
				<div class="tt-col-obj tt-obj-search-type2">
					<div class="tt-search-type2">
						...
						<form action="/search" method="get" role="search">
							<i class="icon-f-85"></i>
							<input class="tt-search-input" type="search" name="q" placeholder="Tìm kiếm sản phẩm..." aria-label="SEARCH PRODUCTS..." autocomplete="off" required>
							...
							<div class="tt-dropdown-menu">
								...
								<div class="tt-dropdown-inner">
									<ul>
									    ...
									    <li id="menu_myaccount"><a href="/my-account"><i class=""></i>Tài Khoản</a></li>
									    <li id="menu_favor"><a href="/my-account/wishlist"><i class=""></i>Danh Sách Yêu Thích</a></li>
									    <li id="menu_login"><a href="/customer/login"><i class=""></i>Đăng Nhập</a></li>
									    <li id="menu_logout"><a href="/customer/logout"><i class=""></i>Đăng Xuất</a></li>
									    <li id="menu_reg"><a href="/signup"><i class=""></i>Đăng Ký</a></li>
									</ul>
								</div>
							</div>
						</div>
