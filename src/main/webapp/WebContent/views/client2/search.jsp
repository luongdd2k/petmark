      ...
      <div class="container">
        <div class="page__title-container">
          <ul class="page__titles">
            ...
            <li class="page__title">Kết quả tìm kiếm cho " "</li>
          </ul>
        </div>
      </div>
    </div>
            ...
            <div class="div-left">
              <div class="block">
                ...
                <div class="list collapsed">
                  <a class="item item--category bold"  href="javascript:" style="padding-left: 0px;">Chó</a>
                  <a class="item item--category bold"  href="javascript:" style="padding-left: 0px;">Mèo</a>
                  <a class="item item--category bold"  href="javascript:" style="padding-left: 0px;">Phụ kiện chó</a>
                  <a class="item item--category bold"  href="javascript:" style="padding-left: 0px;">Phụ kiện mèo</a>
                </div>
              </div>
              <div class="block">
              ...
              <div class="block">
                ...
                <div class="list collapsed">
                  <a class="item item--option_color "  href="javascript:" style="padding-left: 0px;">Đen</a>
              ...
              <div class="block">
                ...
                <div class="list collapsed">
                  <a class="item item--option_size "  href="javascript:" style="padding-left: 0px;">M</a>
                  <a class="item item--option_size "  href="javascript:" style="padding-left: 0px;">L</a>
                </div>
              </div>
            </div>
          </div>
          <div class="lm_m-4 fYDhGF">
            <div class="inner">
              <div class="search-summary">
                <div class="title">
                  <h1>Kết quả tìm kiếm cho " vòng cổ cho mèo ": </h1>
                  <h4>10k+ kết quả</h4>
                </div>
                <div class="Sorter__Root-sc-1u1tc3w-0 jdfxzb">
                  <div class="Sorter__Top-sc-1u1tc3w-1 ftKDwW">
                    <div class="Sorter__Tabs-sc-1u1tc3w-3 ehYkVZ">
                      ...
                      <div class="sort-list">
                        <a class="active"  href="javascript:">Chọn lọc</a>
                        <a class=""  href="javascript:">Hàng mới</a>
                        <a class=""  href="javascript:">Bán chạy</a>
                        <a class=""  href="javascript:">Giảm giá nhiều</a>
                        <a class=""  href="javascript:">Giá thấp</a>
                        <a class=""  href="javascript:">Giá cao</a>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="ProductList__Wrapper-sc-1dl80l2-0 healEa">
                <a class="product-item"  href="javascript:">
                  <span class="style__StyledItem-sc-18svp8n-0 bHrHjw">
                    <div>
                      <div class="thumbnail">
                        <img src="https://salt.tikicdn.com/cache/200x200/ts/product/d3/e7/93/2fab1cf3c4497f66fbb8268b5a317a90.jpg" alt="Vòng cổ đệm cho chó (Chọn 4 màu) - Vòng cổ chó mèo 5 size thích hợp mọi loại chó">
                      </div>
                      <div class="info">
                        <div class="badge-service"></div>
                        <div class="name">
                          <span>Vòng cổ đệm cho chó (Chọn 4 màu) - Vòng cổ chó mèo 5 size thích hợp mọi loại chó</span>
                        </div>
                        <div class="rating-review">
                          <div class="rating">
                            <div class="rating__total">
                              <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" size="12" color="#c7c7c7" height="12" width="12" xmlns="http://www.w3.org/2000/svg" style="color: rgb(199, 199, 199);">
