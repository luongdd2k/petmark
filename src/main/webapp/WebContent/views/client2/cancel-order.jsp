			...
			<div class="container">
              ...
              <use xlink:href="./images/sprite.svg#icon-menu"></use>
                  ...
                  <use xlink:href="./images/sprite.svg#icon-cross"></use>
						...
						<ul class="nav__list">
							...
							<li class="nav__item"><a href="#category" class="nav__link">Sản
									phẩm</a></li>
							<li class="nav__item"><a href="javascript:" class="nav__link">Blog</a>
							</li>
							<li class="nav__item"><a href="javascript:" class="nav__link">Liên
									hệ</a></li>
						</ul>
					</div>
					...
					<div class="nav__icons">
						<div id="location" class="hide">
							<a href="javascript:" class="icon__item"> <svg class="icon__user">
                  <use xlink:href="./images/sprite.svg#icon-location"></use>
						...
						<a href="javascript:" class="icon__item"> <svg class="icon__search">
			...
			<div class="container">
				<div class="page__title-container">
                  ...
                  <use xlink:href="./images/sprite.svg#icon-home"></use>
						...
						<li class="page__title">Tất cả đơn hàng đã hủy</li>
					</ul>
				</div>
			</div>
		</div>
						...
						<div class="userpage-sidebar-menu">
							<div class="stardust-dropdown stardust-dropdown--open">
								<div class="stardust-dropdown__item-header">
									<a href="show-account" class="userpage-sidebar-menu-entry">
                                      ...
                                      <g>
                                          <circle cx="7.5" cy="4.5"
													fill="none" r="3.8" stroke-miterlimit="10"></circle>
                                          <path
													d="m1.5 14.2c0-3.3 2.7-6 6-6s6 2.7 6 6" fill="none"
													stroke-linecap="round" stroke-miterlimit="10"></path>
                                      </g>
							...
							<div
								...
								<div class="userpage-sideber-menu__subsection">
									...
									</a> <a href="show-delevering" class="_17BcjA"> <span
										class="_2ilxaJ">Đang giao hàng</span>
                          ...
                          <path fill="none"
							...
							</a> <a href="show-blog" class="userpage-sidebar-menu-entry">
								<div class="userpage-sidebar-menu-entry__icon"
						...
						<div class="my-account-section">
							<div class="my-account-section__header">
								<div class="my-account-section__header-left">
									<div class="my-acount-section__header-title">Đơn hàng đã
										hủy</div>
								</div>
							</div>
																	...
																	<div
																		...
																		<div
																			...
																			<div class="order-content__item__price-text">
																				...
																				<div class="shopee-price--primary">${list.getDisplayTotalAmount() }
																				</div>
																			</div>
																		</div>
																	</div>
