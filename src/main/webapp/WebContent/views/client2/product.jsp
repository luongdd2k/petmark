...
<body>
				...
				<form action="deposit/${pet.getId() }" method="post">
					<div class="product-detail__container">
						<div class="product-detail__left">
							<div class="details__container--left">
								<div class="product__pictures">
									<div class="pictures__container">
										<img onclick="getUrl(this.src)" class="picture"
											src="${img.getImg1() }" id="pic1" />
									</div>
									<div class="pictures__container">
										<img onclick="getUrl(this.src)" class="picture"
											src="${img.getImg2() }" id="pic2" />
									</div>
									<div class="pictures__container">
										<img onclick="getUrl(this.src)" class="picture"
											src="${img.getImg3() }" id="pic3" />
									</div>
									<div class="pictures__container">
										<img onclick="getUrl(this.src)" class="picture"
											src="${img.getImg1() }" id="pic4" />
									</div>
									<div class="pictures__container">
										<img onclick="getUrl(this.src)" class="picture"
											src="${img.getImg3() }" id="pic5" />
									</div>
								</div>
							...
							<div id="btn-action"
								class="product-details__btn product-details__btn_pet">
								<button type="submit"
									class="product-details__btn product-details__btn_pet buy">
									<span> <svg>
							...
							<div id="btn-modal"
								class="product-details__btn product-details__btn_pet">
								<button type="button" class="buy" data-toggle="modal"
									data-target="#myModal">
									<span> <svg>
											<use xlink:href="images/sprite.svg#icon-credit-card"></use>
										</svg>
							...
							<div class="product-detail__content">
								...
								<div class="price">
									<input type="hidden" id="price-a"
										value="${pet.displayDeposit() }"> <span
										class="new__price" id="price">${pet.displayDeposit() }</span>
								</div>
									...
									<ul class="product__info">
										<li class="select">
											<div class="select__option">
												<label for="color">Màu lông - Màu mắt: </label> <select
													name="colors" id="color" class="select-box">
				...
				<div class="container" data-aos="fade-up" data-aos-duration="1200">
					...
					<div class="glide__arrows" data-glide-el="controls">
						<button class="glide__arrow glide__arrow--left" data-glide-dir="<">
							<svg>
                  				<use
									xlink:href="images/sprite.svg#icon-arrow-left2"></use>
                			</svg>
						</button>
						<button class="glide__arrow glide__arrow--right"
							...
							<svg>
                  				<use
									xlink:href="images/sprite.svg#icon-arrow-right2"></use>
                			</svg>
						</button>
					</div>
				</div>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<p class="modal-body__text">
						Bạn cần <a href="showLogin">đăng nhập</a> để mua hàng! Hoặc bạn có
						thể cung cấp thông tin để chúng tôi có thể liên lạc với bạn
					</p>
				</div>
				<div class="modal-footer">
					<button type="button" class="btn btn-danger" data-dismiss="modal">Đóng</button>
					<button type="button" class="btn btn-success" onclick="b()"
						data-dismiss="modal" data-toggle="modal"
						data-target="#myModalForm">Thông tin</button>
				</div>
			</div>
			<%--End modal content--%>
		</div>
	...
	<div class="modal fade " id="myModalForm" role="dialog">
		<div class="modal-dialog modal-lg modal-dialog-centered">
			...
			<div class="modal-content">
				<div class="modal-header">
					<h2 class="modal-title" id="exampleModalLabel1">Thông tin cá
						nhân</h2>
					<button type="button" class="close" data-dismiss="modal"
						aria-label="Close">
						<span aria-hidden="true">&times;</span>
						...
						<div class="row">
							<div class="col-6">
								<div class="form-group">
									<label for="name">Họ và tên (<span style="color: red;">*</span>)</label> <input type="text"
										class="form-control" id="name" name="ten"
							...
							<div class="col-6">
								<div class="form-group">
									<label for="phone">Số điện thoại (<span style="color: red;">*</span>)</label> <input type="tel"
							...
							<div class="col-12">
								<div class="form-group">
									<label for="phone">Email (<span style="color: red;">*</span>)</label> <input type="email"
							...
							<div class="col-4">
								<div class="form-group">
									<label for="city2">Tỉnh / Thành phố (<span style="color: red;">*</span>)</label> <select
							...
							<div class="col-4">
								<div class="form-group">
									<label for="district2">Quận / Huyện (<span style="color: red;">*</span>)</label> <select
										class="form-control" aria-label="Default select example"
							...
							<div class="col-4">
								<div class="form-group">
									<label for="village2">Xã / Phường / Thị trấn (<span style="color: red;">*</span>)</label> <select
										class="form-control" aria-label="Default select example"
							...
							<div class="col-12">
								<div class="form-group">
									...
									<textarea class="form-control" id="address" rows="2"
										name="address" placeholder="Địa chỉ nhận hàng"></textarea>
									<p id="error7"
										style="color: red; font-weight: 400; font-size: 14px;"
										class="hide"></p>
								</div>
							...
							<div class="col-4" style="margin-top: 30px;">
								<input type="hidden" class="form-control" id="city-id"
									name="matp" value=""> <input type="hidden"
									class="form-control" id="district-id" name="maqh" value="">
								<input type="hidden" class="form-control" id="village-id"
									name="xaid" value="">
							</div>
						</div>
					</div>
