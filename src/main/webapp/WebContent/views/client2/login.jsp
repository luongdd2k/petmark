...
<body>
	<div class="container">
		<form class="border border-light form-div" action="CheckLogin"
			id="sl_form_login" method="post">
			<div class="row form-content sl_form_input">
				<div class="col-12">
				...
				<div class="form-check col-6">
					<input class="form-group-input" type="checkbox" value=""
						...
						for="defaultCheck1"> Nhớ mật khẩu </label>
				</div>
				<div class="form-check col-6" style="text-align: right;">
					<a href="showforgotpw">Quên mật khẩu</a>
				</div>
				<div class="form-group col-12">
					<button class="btn btn-info btn-block btn-js sl_submit"
