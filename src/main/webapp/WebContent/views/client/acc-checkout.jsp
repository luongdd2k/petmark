          ...
          <div class="navigation__column center">
            <ul class="main-menu menu">
              <li class="menu-item menu-item-has-children dropdown"><a href="index.html">Home</a>
                <ul class="sub-menu">
                  <li class="menu-item"><a href="javascript:">Pet</a></li>
                  <li class="menu-item"><a href="javascript:">Accessori</a></li>
                </ul>
              </li>
              ...
              <li class="menu-item"><a href="javascript:">Search by Guest Code</a></li>
            </ul>
          </div>
                    ...
                    <div class="ps-checkout__order">
                      ...
                      <div class="content">
                        <table class="table ps-checkout__products">
                          <thead>
                            <tr>
                              <th class="text-uppercase">Accessori</th>
