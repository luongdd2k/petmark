...
<body class="ps-loading">
        ...
        <nav class="navigation">
            <div class="container-fluid">
                ...
                <div class="navigation__column right">
                    ...
                    <div class="ps-cart"><a class="ps-cart__toggle" href="cart.html"><span><i>1</i></span><i
    ...
    <main class="ps-main">
        <aside>
            <section>
                <div>
                    <p style="font-size: 15px; padding-top: 20px; padding-left: 50px;"> Tài khoản của <span style="font-weight: bold; color: black; font-size: 20px;">Huệ Ơi</span></p> 
                </div>
                <br>
        ...
        <div class="content">
            <section class="prod container">
                <form class="row form-container disabled">
                    <!-- <div class="form-row"> -->
                      <div class="form-group col-md-4">
                        <label for="inputEmail4">Họ và tên</label>
                        <input type="name" class="form-control" id="inputname" placeholder="" value="Hải Hút Hít">
                      </div>
                    <!-- </div> -->
                    <div class="form-group col-md-4">
                      <label for="inputAddress">Số điện thoại</label>
                      <input type="text" class="form-control" id="inputAddress" placeholder="" value="0866652444">
                    </div>
                    <div class="form-group col-md-4">
                    ...
                    <div class="form-group col-md-4">
                      ...
                      <input type="text" class="form-control" id="inputAddress2" placeholder="" value="Số 47-Phạm Văn Đồng-Cầu Giấy-Hà Nội">
                    </div>
                    <!-- <div class="form-row"> -->
                      <div class="form-group col-md-4">
                        <label for="inputCity">Email</label>
                        <input type="text" class="form-control" id="inputCity" value="haihonghot@gmai.com">
                      </div>
                      <!-- <div class="form-group col-md-4">
                    ...
                    <!-- </div> -->
                    <div class="form-group col-md-4">
                        <label for="myDate2">Ngày sinh</label>
                        <input type="date" id="myDate2" class="form-control" min="1900-01-01" max="2020-12-31" value="2000-04-04">
                    </div>
                </form>
                <div class="row">
                    <button class="btn btn-suaTT" id="suaThongTin">Sửa thông tin</button>
                    <button class="btn btn-suaTT ml-auto hidden" id="huySuaThongTin">Huỷ</button>
                    <button class="btn btn-suaTT hidden" id="luuThongTin">Lưu</button>
                </div>
            </section>

        </div>
    </main>
    <footer class="ps-footer bg--cover"
    ...
    <script type="text/javascript" src="js/acc-information.js"></script>
</body>
