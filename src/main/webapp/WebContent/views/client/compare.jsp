          ...
          <div class="ps-cart-listing ps-table--compare">
            <table class="table ps-cart__table">
              <tbody>
                ...
                <tr>
                  <td>Order</td>
                  <td><a class="ps-btn" href="javascript:">Add to cart<i class="ps-icon-next"></i></a><a class="ps-product-favorite ml-10" href="whishlist.html"><i class="ps-icon-heart"></i></a></td>
                  <td><a class="ps-btn" href="javascript:">Add to cart<i class="ps-icon-next"></i></a><a class="ps-product-favorite ml-10" href="whishlist.html"><i class="ps-icon-heart"></i></a></td>
                </tr>
              </tbody>
            </table>
