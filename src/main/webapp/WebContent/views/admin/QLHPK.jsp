...
<HTML>
	<HEAD>
		...
		<TITLE>Quản lý hãng phụ kiện</TITLE>
	...
	<BODY>
		...
		<div id="bgf4"><div id="bgbg" style="background-image: none;"><div id="all" style="min-height: 970px;">
			<div class="menu_title">QUẢN LÝ HÃNG PHỤ KIỆN</div>
			
			<div id="Category_QL">
				
				<input type="hidden" id="imgPath" value="${imgPath}">
				<div class="p_title_2">Thêm hãng phụ kiện mới</div>
				<table class="add_p">
					<thead>
						<tr>
							<td class="t_image">Ảnh</td>
							<td class="t_name">Tên hãng</td>
					...
					<form id="formAddCategory"
						...
						<tr>
							<table class="add_p">
								<tbody>
									<tr>
										<td class="t_image" id="add_img_header"
											style="position: relative; height: 110px; overflow: hidden">
											<input type="hidden" name="hiddenImgPath" id="hiddenImgPath"
											value="Image/other/samplePhoneUpload.svg"> <input
											type="file" name="addCategoryIMG" id="add_img"
											style="display: none;"> <input type='hidden'
											id="added" name='added' value='${add }'> <img
											id="addCategoryIMGtag" src="Image/other/samplePhoneUpload.svg"
											style="width: 100%;">
											<div id="img_fff"
										...
										<td class="t_information"><input type="text"
											class="p_information" id="p_add_information"
											name="p_add_information" autocomplete="off"></td>
				...
				<select id="cbo_sort_Category2" style="">
				...
				<table class="show_p" style="margin-top: 30px;">
					...
					<c:forEach var="Category" items="${listCategory }">
						...
						<form action='admin/CategoryManagement/UpdateCategory' method='POST' enctype='multipart/form-data' class='show_f' ><table class='show_p' >
						<tbody>
								<tr>
									<td><input class="p_fix_id" id="p_fix_id" name="p_fix_id" value="${Category.getId() }" readonly='readonly'></td>
									<td class='t_name'>
										<input type='hidden' name='formIndex' class='formIndex' value='${count }'>
										<input type='text' name='p_fix_name' class='p_fix_name' value='${Category.getName() }' autocomplete='off' required>
										<a target='_blank' href='ViewCategory/${Category.getId() }' class='p_more'>Xem chi tiết</a>
										<div class="countVLC">
									...
									<td class='t_quantity'><input type='text' name='p_fix_information' class='p_fix_information' value='${Category.getDescription() }' autocomplete='off'></td>
									...
									<td class='t_action_2'>
										<input type='file' name='addCategoryIMG' class='fix_img' style='display: none'>
