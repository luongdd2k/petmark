                                        ...
                                        <div class="col-12 col-sm-6 col-md-3">
                                            <div style="float: right; margin-bottom: 15px;">
                                                <a type="button" class="btn btn-danger"
                                                    href="./order-status-cancelOrder.html">
                                                    <i class="fas fa-calendar-times"></i>
                                                    <span> Hủy đơn hàng này</span></a>
                                            </div>
                                        </div>
                                    </div>
                                    <!--End Row .Button Huy-->
                                    ...
                                    <div style="border: solid 1px black; max-width: 100%; margin: auto; height: 100%;">
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                ...
                                                <p style="padding-left: 30px; margin-top: -8px;font-size: 16px;">
                                                    <strong>Chuẩn bị giao hàng</strong></p>
                                            </div>
                                        </div>
                                        <!-- End .row infor-->
                                    </div>
                                        ...
                                        <div class="col-12 col-sm-6 col-md-3">
                                            <div style="margin-top: 15px; margin-bottom: 10px;">
                                                <a class="btn btn-custon-three btn-primary"
                                                    href="./order-status-1stTran.html">
                                                    <i class="fas fa-meteor"></i>
                                                    <span> Bắt đầu giao hàng</span></a>
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-6 col-md-3">
                                        </div>
