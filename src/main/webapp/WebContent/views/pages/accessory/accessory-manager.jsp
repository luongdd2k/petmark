						...
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								<li class="breadcrumb-item">
									<a href="index4.html">Trang chủ</a>
								</li>
							...
							<div class="table-responsive-xl main-table">
								<table class="table table-hover" style="margin-bottom: -1%" id="table-js">
									...
									<c:forEach var="Accessories" items="${listAccessories}">
										<tbody>
											<tr>
												<th scope="row" class="td-center idthu">${Accessories.id }</th>
												<td>
													<img class="img-fluid" src="${Accessories.getImgs().get(0).getImgAvartar() }"
													alt="" style="max-width: 70px; max-height: 70px;"></td>
												<td class="td-center tenthucung" ><div
														onclick="showFormUpdate(true, ${Accessories.id})" class="alert-link">${Accessories.name }</div></td>
												<td class="td-center"><span hidden="true">${Accessories.getCategory().getId() }</span>
													${Accessories.getCategory().getName() }</td>
												<!-- <td class="td-center" style="padding-top: 2.5%;">Đỏ</td> -->
												<td class="td-center">${Accessories.getDisplayPrice(1) }</td>
												<td class="td-center" >${Accessories.getAmount() }</td>
												<td class="td-center">${Accessories.getDate() }</td>
												<td class="td-center" >${Accessories.getStatus() }</td>
												<td class="td-center" hidden="true">${Accessories.getDescription()}</td>
												<td class="td-center">
