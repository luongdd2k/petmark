...
<body class="hold-transition sidebar-mini">
	<div class="wrapper">
		...
		<aside class="main-sidebar sidebar-light-primary elevation-4">
			<!-- Brand Logo -->
			<a href="index4.html" class="brand-link"> <img
         ...
         with font-awesome or any other icon font library -->
						<li class="nav-item has-treeview"><a href="index4.html"
				...
				<div class="container-fluid">
					...
					<div class="card card-default color-palette-box">
						<div class="card-header">
							<h3 class="card-title">
								<i class="fas fa-tag"></i> Quản lý phụ kiện
							</h3>
						</div>
						<div class="card-body">
									...
									style="width: 330px; margin-left: 30px; float: left;">
										...
										<div class="form-group">
											<label for="exampleFormControlInput1">Tên phụ kiện</label> <input
												type="text" class="form-control" id="accessoriName" name="name">
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											<label for="exampleFormControlInput1">Số lượng</label> <input
												type="text" class="form-control" id="accessoriAmount" name="quantity">
										</div>
<!-- 										<div class="form-group"> -->
<!-- 											<label for="exampleFormControlInput1">Màu sắc</label> <input -->
<!-- 												type="text" class="form-control" id="accessoriColor"> -->
<!-- 										</div> -->
									...
									style="width: 330px; margin-left: 30px; float: left;">
										...
										<div class="form-group">
											<label for="exampleFormControlInput1">Giá</label> <input
												type="text" class="form-control" id="accessoriPrice" name="price">
										</div>
										<div class="form-group">
											<label for="exampleFormControlSelect1">Trạng thái</label> <select
												name="status" id="accessori-status"
												style="height: 30px; width: 100%;">
										...
										<div class="form-group">
											...
											<textarea class="form-control" id="accessoriInformation"
												rows="2" name="mota"></textarea>
										</div>
								</div>
								<div class="form-disable-p1"
									style="width: 330px; margin-left: 30px; float: left;">
...
<!-- 										</div> -->
									...
									<div style="margin-top: 40px;">
										<button type="submit"
											class="btn btn-custon-rounded-three btn-success btn-css">Save</button>
<!-- 										<button type="button" -->
<!-- 											class="btn btn-custon-rounded-three btn-warning btn-css">Clear</button> -->
										<button type="button"
...
<!-- 											<th scope="col">Màu</th> -->
											...
											<th scope="col" class="t_action_3">Hành động</th>
										</tr>
									</thead>
									<c:forEach var="Accessories" items="${listAccessories}">
									<tbody>
										<tr>
											<th scope="row" class="td-center idthu" style="padding-top: 2.5%;">${Accessories.id }</th>
											...
											<td class="td-center tenthucung" style="padding-top: 2.5%;"><a
												href="javascript:" onclick="hienThi(true)">${Accessories.name }</a></td>
											<td class="td-center" style="padding-top: 2.5%;">${Accessories.getCategory().getName() }</td>
<!-- 											<td class="td-center" style="padding-top: 2.5%;">Đỏ</td> -->
											...
											<td class="td-center" style="padding-top: 2.5%;">${Accessories.getDescription() }</td>
