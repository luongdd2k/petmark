    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
      ...
      <form class="form-inline ml-3">
        <div class="input-group input-group-sm">
          <input class="form-control form-control-navbar" type="search" placeholder="Tìmm kiếm ..." aria-label="Search">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
            ...
            <a href="#" class="dropdown-item">
              <i class="fas fa-envelope mr-2"></i> 4 tin nhắn mới
              ...
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">
                    ...
                    Quản lí hãng phụ kiện
                  </h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                  <div id="form-disable" style="display:none; max-width: 100%;margin-top: 10px;" >
                    <div class="form-disable-p1" style="width: 400px;margin-left: 30px; margin: auto;">
                        <form id="formAddCategory" action="admin/CategoryManagement/AddCategory" method="POST">
                            <div class="form-group">
                                <label for="exampleFormControlInput1">Tên hãng</label>
                                <input type="text" class="form-control" id="category" name="name">
                            </div>
                            <div class="form-group">
                                <label for="exampleFormControlInput1">Thông tin thêm</label>
                                <input type="text" class="form-control" id="category" name="thongtin">
                            </div>
                ...
                <!-- End Form -->
                  ...
                  <div class="main-table">
                    <table class="table" style="margin-bottom: -1%;">
                        ...
                        <tbody>
                            <tr>
                                <th scope="row" class="td-center" style="padding-top: 2.5%;">${Category.getId() }</th>
                                <td class="td-center" style="padding-top: 2.5%;"><a href="javascript:"onclick="hienThi(true)">${Category.getName() }</a></td>
