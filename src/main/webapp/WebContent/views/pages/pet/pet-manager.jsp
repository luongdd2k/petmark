            ...
            <div class="col-12">
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <div id="form-disable" style="display:none; max-width: 95%; margin: auto;">
                    <div class="form-disable-p1 float-left" style="width: 330px;margin-left: 30px;float: left;">
                        ...
                        <div class="form-group">
                          ...
                          <select name="giong" id="pet-bread" style="height: 30px;width: 100%;">
                         ...
                         <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="petAge" name="age">
                        </div>
                    ...
                    <div class="form-disable-p1" style="width: 330px;margin-left: 30px;float: left;">
                        ...
                        <div class="form-group">
                          ...
                          <select name="status" id="pet-bread" style="height: 30px;width: 100%;">
                    ...
                    <div class="form-disable-p1" style="width: 330px;margin-left: 30px;float: left;">
                        ...
                        <div class="form-group">
                          ...
                          <textarea class="form-control" id="petInformation" rows="2" name="mota"></textarea>
                        </div>
                    
                      <div style="margin-top: 40px;">
                        <button type="submit" class="btn btn-custon-rounded-three btn-success btn-css">Save</button>
                        <button type="button" class="btn btn-custon-rounded-three btn-danger btn-css"
                          onclick="hienThi(false)">Cancel</button>
                      </div>
                    </div>
                    <div class="clear"></div>
                  </div>
                  ...
                  <div class="btn-new-css">
                    <button id="new-pet" type="button" class="btn btn-custon-rounded-three btn-primary"
                      style="display: block;" onclick="hienThi(true)">Thêm mới</button>
                  </div>
                  <!-- End Thêm mới-->
...
<!--                           <th scope="col">Màu mắt</th> -->
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td class="td-center" style="padding-top: 2.5%;"><a href="javascript:"
                              onclick="hienThi(true)">${product.petName }</a></td>
                          <td class="td-center" style="padding-top: 2.5%;">${product.getSpecies().getName() }</td>
<!--                           <td class="td-center" style="padding-top: 2.5%;">Xám trắng</td> -->
<!--                           <td class="td-center" style="padding-top: 2.5%;">Xanh dương</td> -->
                          <td class="td-center" style="padding-top: 2.5%;">${product.age } tháng</td>
                          ...
                          <td class="td-center" style="padding-top: 2.5%;">${product.amount} con</td>
                          ...
                          <td class="td-center" style="padding-top: 2%;">
                            <button type="button" class="btn btn-custon-rounded-three btn-danger">Ngừng kinh
                              doanh</button>
                          </td>
                        </tr>
                      </tbody>
