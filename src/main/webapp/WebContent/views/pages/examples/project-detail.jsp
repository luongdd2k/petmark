          ...
          <div class="row">
                ...
                <div class="col-12">
                  <h4>Recent Activity</h4>
                    <div class="post">
                      ...
                      <p>
                        <a href="javascript:" class="link-black text-sm"><i class="fas fa-link mr-1"></i> Demo File 1 v2</a>
                      </p>
                    </div>
                    ...
                    <div class="post clearfix">
                      ...
                      <p>
                        <a href="javascript:" class="link-black text-sm"><i class="fas fa-link mr-1"></i> Demo File 2</a>
                      </p>
                    </div>
                    ...
                    <div class="post">
                      ...
                      <p>
                        <a href="javascript:" class="link-black text-sm"><i class="fas fa-link mr-1"></i> Demo File 1 v1</a>
                      </p>
                    </div>
                </div>
              </div>
            ...
            <div class="col-12 col-md-12 col-lg-4 order-1 order-md-2">
              ...
              <div class="text-center mt-5 mb-3">
                <a href="javascript:" class="btn btn-sm btn-primary">Add files</a>
                <a href="javascript:" class="btn btn-sm btn-warning">Report contact</a>
              </div>
            </div>
          </div>
        </div>
