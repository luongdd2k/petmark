...
<header id="header" class="header">
	<div class="navigation">
		...
		<input type="hidden" id="is-empty" value="${isEmpty }" /> <input
			type="hidden" id="hadBlog" value="1" /> <input type="hidden"
			id="valuePetOrAccessori" value="${loai }" />
				...
				<div class="nav__menu">
					...
					<ul class="nav__list">
						...
						<li class="nav__item"><a href="#category" class="nav__link">Sản
								phẩm</a></li>
						<li class="nav__item"><a href="show-search-pet"
							class="nav__link">Thú cưng</a></li>
						<li class="nav__item"><a href="show-search-acc"
							class="nav__link">Phụ kiện</a></li>
